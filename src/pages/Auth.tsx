...
import { Mail, Lock, LogIn, UserPlus, Loader2, ArrowLeft, Eye, EyeOff } from "lucide-react";
              ...
              <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="login-password" type={showPassword ? "text" : "password"} placeholder="Your password" className="pl-10 pr-10" {...loginForm.register("password")} />
